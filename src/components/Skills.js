...
const Skill = ({name, x, y}) =>{
    ...
    return (
        ...
        absolute dark:text-dark dark:bg-light lg:py-1  lg:px-4 md:text-sm md:py-1.5 md:px-3
        xs:bg-transparent  xs:text-dark xs:dark:text-dark xs:font-bold
        '  
...
const Skills = () => {
 ...
 <div className='w-full h-screen relative flex items-center justify-center
       ...
       text-light  py-3 px-6 shadow-dark cursor-pointer  dark:text-dark dark:bg-light
