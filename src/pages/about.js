...
const about = () => {
  return (
    <>
    <Head>
       <title>Ogbonna_Michael | About Page</title>
        ...
        <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
              <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2  md:col-span-8'>
                ...
                <p className='font-medium'>  
                    Hi, I am Michael, a UI/UX designer and a web developer  with a passion for creating beautiful, functional, 
                    and user-centered digital experiences. With over 8 years of experience in the field. I am always looking for 
           ...
           '>
              ...
              <Image src={profilePic} alt="ogbonna michael" className='w-full h-auto rounded-2x1'
               priority
